...
from sklearn.metrics import confusion_matrix
from functions_Q2_Reinforcement_forgetting import *
cwd = os.getcwd()
...
t0=time.time()
alfa_star,m,M,iter,sol=decomposition(X_train,y_train,C,gamma,q,tolerance,max_iter,k_type)
t1=time.time()
opt_time=t1-t0
